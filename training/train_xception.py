...
train_gen, val_gen = create_generators('../chest_xray_dataset', target_size=(299,299))
...
callbacks = [ModelCheckpoint(r'../backend/models/xception_covid.h5', save_best_only=True),
